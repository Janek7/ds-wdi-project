...
public class PlatformComparatorAdvanced implements Comparator<VideoGame, Attribute> {
	...
	public PlatformComparatorAdvanced(SimilarityMeasure<String> stringSimilarityMeasure) {
