...
public class VideoGamePlatformComparator implements Comparator<VideoGame, Attribute> {
	...
	public VideoGamePlatformComparator(SimilarityMeasure<String> stringSimilarityMeasure) {
