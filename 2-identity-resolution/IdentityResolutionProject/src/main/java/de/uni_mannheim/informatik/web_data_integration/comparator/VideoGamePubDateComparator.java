...
public class VideoGamePubDateComparator implements Comparator<VideoGame, Attribute> {
	...
	public VideoGamePubDateComparator(int year) {
      this.sim = new YearSimilarity(year);
    }
