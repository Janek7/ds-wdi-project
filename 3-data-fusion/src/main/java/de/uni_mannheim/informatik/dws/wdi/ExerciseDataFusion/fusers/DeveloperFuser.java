...
public class DeveloperFuser extends AttributeValueFuser<String, VideoGame, Attribute> {

	public DeveloperFuser(ConflictResolutionFunction resolutionFunction) {
