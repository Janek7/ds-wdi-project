...
public class VideoGameXMLFormatter extends XMLFormatter<VideoGame> {
    ...
    public Element createElementFromRecord(VideoGame record, Document doc) {
        ...
        videoGame.appendChild(createTextElement("age", record.isAgeWasRead() ? Integer.toString(record.getAge()) : "", doc));
        videoGame.appendChild(createTextElement("price", record.isPriceWasRead() ? Double.toString(record.getPrice()) : "", doc));
